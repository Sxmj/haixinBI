<template>
  <div class="tv_product">
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card>
          <h3 class="chart_title">海信手机服务NPS维修环节</h3>
    ...
    <el-row :gutter="20" class="ranking">
      <el-card>
        ...
        <div id="chartSell" class="chartSellBox"></div>
        <div style="padding-left:125px;margin-top:30px">
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="apple" label="苹果" width="90" align="center"></el-table-column>
            <el-table-column prop="huawei" label="华为" width="90" align="center"></el-table-column>
            <el-table-column prop="oppo" label="OPPO" width="90" align="center"></el-table-column>
            <el-table-column prop="rongyao" label="荣耀" width="90" align="center"></el-table-column>
            <el-table-column prop="vivo" label="VIVO" width="90" align="center"></el-table-column>
            <el-table-column prop="xiaomi" label="小米" width="90" align="center"></el-table-column>
            <el-table-column prop="sanxing" label="三星" width="90" align="center"></el-table-column>
            <el-table-column prop="meilan" label="魅蓝" width="90" align="center"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      phone_fixrepresentat: phone_fixrepresentat,
      haixinData_x: [],
      phone_fixattention: phone_fixattention, //指标关注度
      data_lists: phone_fixdata,
      percentArray: [40.9, 1.2, 9.1, 27.3, 4.5, "-", "-"],
  ...
  created() {
    ...
    this.phone_fixattention = ranking(that.phone_fixattention);
    this.phone_fixrepresentat = getData2(
      phone_fixattention,
      that.phone_fixrepresentat
    );
    this.haixinData_x = getData_x(that.phone_fixrepresentat, [
      "\n" +
  ...
  methods: {
    currentChange(index) {
      ...
      if (index == "1") {
        ...
        // console.log(this.sellPromotion_arr)
        this.xAxis = [
          {
            type: "category",
            // data: ['海信','三星','索尼','夏普','小米','TCL','海尔','创维'],
            data: getRanking(ranking_pr(this.sellPromotion_arr)).arr_name,
            axisPointer: {
              type: "shadow"
            },
            name: "品牌NPS排位",
        ...
        this.series = [
          {
            ...
            type: "bar",
            // data:[ 58.8, 65.6, 66.6, 53.7, "","51.0",55.0,"51.0"],
            data: getRanking(ranking_pr(this.sellPromotion_arr)).arr_2017,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  ...
                  // var colorList = ['#a3e1d4','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  //  return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.sellPromotion_arr))
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 58.3, 60.6, 67.2, 52.5, "",50.3,48.4,49.3],
            data: getRanking(ranking_pr(this.sellPromotion_arr)).arr_2018,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 62.4, 63.7, 66.0, 58.1, 56.5,55.9,54.1,56.3],
            data: getRanking(ranking_pr(this.sellPromotion_arr)).arr_2019,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
        ...
        this.xAxis = [
          {
            type: "category",
            // data: ['海信','三星','索尼','夏普','小米','TCL','海尔','创维'],
            data: getRanking(ranking_pr(this.sellSendQuality_arr)).arr_name,
            axisPointer: {
              type: "shadow"
            },
            name: "品牌NPS排位",
        ...
        this.series = [
          {
            ...
            type: "bar",
            // data:[ 58.8, 65.6, 66.6, 53.7, "","51.0",55.0,"51.0"],
            data: getRanking(ranking_pr(this.sellSendQuality_arr)).arr_2017,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  ...
                  // var colorList = ['#a3e1d4','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  //  return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.sellSendQuality_arr))
                    .arr_2017[params.dataIndex].color;
                }
              }
            }
          },
          {
            ...
            type: "bar",
            // data:[ 58.3, 60.6, 67.2, 52.5, "",50.3,48.4,49.3],
            data: getRanking(ranking_pr(this.sellSendQuality_arr)).arr_2018,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 62.4, 63.7, 66.0, 58.1, 56.5,55.9,54.1,56.3],
            data: getRanking(ranking_pr(this.sellSendQuality_arr)).arr_2019,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
        ...
        this.xAxis = [
          {
            type: "category",
            // data: ['海信','三星','索尼','夏普','小米','TCL','海尔','创维'],
            data: getRanking(ranking_pr(this.sellShowProduct_arr)).arr_name,
            axisPointer: {
              type: "shadow"
            },
            name: "品牌NPS排位",
        ...
        this.series = [
          {
            ...
            type: "bar",
            // data:[ 58.8, 65.6, 66.6, 53.7, "","51.0",55.0,"51.0"],
            data: getRanking(ranking_pr(this.sellShowProduct_arr)).arr_2017,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  ...
                  // var colorList = ['#a3e1d4','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  //  return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.sellShowProduct_arr))
                    .arr_2017[params.dataIndex].color;
                }
              }
            }
          },
          {
            ...
            type: "bar",
            // data:[ 58.3, 60.6, 67.2, 52.5, "",50.3,48.4,49.3],
            data: getRanking(ranking_pr(this.sellShowProduct_arr)).arr_2018,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 62.4, 63.7, 66.0, 58.1, 56.5,55.9,54.1,56.3],
            data: getRanking(ranking_pr(this.sellShowProduct_arr)).arr_2019,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
        ...
        this.xAxis = [
          {
            type: "category",
            // data: ['海信','三星','索尼','夏普','小米','TCL','海尔','创维'],
            data: getRanking(ranking_pr(this.sellProfile_arr)).arr_name,
            axisPointer: {
              type: "shadow"
            },
            name: "品牌NPS排位",
        ...
        this.series = [
          {
            ...
            type: "bar",
            // data:[ 58.8, 65.6, 66.6, 53.7, "","51.0",55.0,"51.0"],
            data: getRanking(ranking_pr(this.sellProfile_arr)).arr_2017,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  ...
                  // var colorList = ['#a3e1d4','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  //  return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.sellProfile_arr)).arr_2017[
                    params.dataIndex
                  ].color;
                }
              }
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 58.3, 60.6, 67.2, 52.5, "",50.3,48.4,49.3],
            data: getRanking(ranking_pr(this.sellProfile_arr)).arr_2018,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  // var colorList = ['#6dbccf','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  // return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.sellProfile_arr)).arr_2018[
                    params.dataIndex
                  ].color;
                }
              }
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 62.4, 63.7, 66.0, 58.1, 56.5,55.9,54.1,56.3],
            data: getRanking(ranking_pr(this.sellProfile_arr)).arr_2019,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  // var colorList = ['#17b3a3','#808080','#808080','#808080','#808080','#808080','#808080','#808080','#808080','#808080'];
                  // return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.sellProfile_arr)).arr_2019[
                    params.dataIndex
                  ].color;
                }
              }
        ...
        this.xAxis = [
          {
            type: "category",
            // data: ['海信','三星','索尼','夏普','小米','TCL','海尔','创维'],
            data: getRanking(ranking_pr(this.talked_arr)).arr_name,
            axisPointer: {
              type: "shadow"
            },
            name: "品牌NPS排位",
        ...
        this.series = [
          {
            ...
            type: "bar",
            // data:[ 58.8, 65.6, 66.6, 53.7, "","51.0",55.0,"51.0"],
            data: getRanking(ranking_pr(this.talked_arr)).arr_2017,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  ...
                  // var colorList = ['#a3e1d4','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  //  return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.talked_arr)).arr_2017[
                    params.dataIndex
                  ].color;
                }
              }
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 58.3, 60.6, 67.2, 52.5, "",50.3,48.4,49.3],
            data: getRanking(ranking_pr(this.talked_arr)).arr_2018,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  // var colorList = ['#6dbccf','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  // return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.talked_arr)).arr_2018[
                    params.dataIndex
                  ].color;
                }
              }
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 62.4, 63.7, 66.0, 58.1, 56.5,55.9,54.1,56.3],
            data: getRanking(ranking_pr(this.talked_arr)).arr_2019,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  // var colorList = ['#17b3a3','#808080','#808080','#808080','#808080','#808080','#808080','#808080','#808080','#808080'];
                  // return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.talked_arr)).arr_2019[
                    params.dataIndex
                  ].color;
                }
              }
        ...
        this.xAxis = [
          {
            type: "category",
            // data: ['海信','三星','索尼','夏普','小米','TCL','海尔','创维'],
            data: getRanking(ranking_pr(this.serviceweek_arr)).arr_name,
            axisPointer: {
              type: "shadow"
            },
            name: "品牌NPS排位",
        ...
        this.series = [
          {
            ...
            type: "bar",
            // data:[ 58.8, 65.6, 66.6, 53.7, "","51.0",55.0,"51.0"],
            data: getRanking(ranking_pr(this.serviceweek_arr)).arr_2017,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  ...
                  // var colorList = ['#a3e1d4','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  //  return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.serviceweek_arr)).arr_2017[
                    params.dataIndex
                  ].color;
                }
              }
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 58.3, 60.6, 67.2, 52.5, "",50.3,48.4,49.3],
            data: getRanking(ranking_pr(this.serviceweek_arr)).arr_2018,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  // var colorList = ['#6dbccf','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  // return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.serviceweek_arr)).arr_2018[
                    params.dataIndex
                  ].color;
                }
              }
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 62.4, 63.7, 66.0, 58.1, 56.5,55.9,54.1,56.3],
            data: getRanking(ranking_pr(this.serviceweek_arr)).arr_2019,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  // var colorList = ['#17b3a3','#808080','#808080','#808080','#808080','#808080','#808080','#808080','#808080','#808080'];
                  // return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.serviceweek_arr)).arr_2019[
                    params.dataIndex
                  ].color;
                }
              }
        ...
        series: [
          {
            ...
            type: "bar",
            barWidth: "40%",
            data: that.phone_fixrepresentat,
            label: {
              normal: {
                show: true,
                position: "top",
          ...
          },
          {
            ...
            smooth: true,
            yAxisIndex: 1,
            data: that.phone_fixattention //[25, 14, 10, 10, 3, 10, 7]
          }
        ]
      };
    ...
    initSellChart() {
      ...
      this.chartProduct = echarts.init(document.getElementById("chartSell"));
