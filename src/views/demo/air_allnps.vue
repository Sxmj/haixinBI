    ...
    <el-row :gutter="20">
        ...
        <el-card class="nps_card">
          ...
          <div class="nps_box">
            ...
            <div class="data_table">
              ...
              <p>2、左上方为空调品类2019年的NPS权重计算公式</p>
              <p>【下图数据】</p>
              <p>展现空调品类下的产品模块、销售模块、服务模块与竞品的对比情况</p>
        ...
        <el-card class="hand">
          <div @click="goProduct">
            <el-row type="flex" justify="space-between" align="middle" style="padding:0 0 20px">
              <span class="span_h5 color_17b3a3">海信空调产品</span>
      ...
      <el-col :span="8">
        <el-card class="hand">
          <div @click="goSell">
            <el-row type="flex" justify="space-between" align="middle" style="padding:0 0 20px">
              <span class="span_h5 color_17b3a3">海信空调销售</span>
              <span class="span_box">2019年</span>
            </el-row>
      ...
      <el-col :span="8">
        <el-card class="hand">
          <div @click="goService">
            <el-row type="flex" justify="space-between" align="middle" style="padding:0 0 20px">
              <span class="span_h5 color_17b3a3">海信空调服务</span>
              <span class="span_box">2019年</span>
            </el-row>
...
export default {
  ...
  methods: {
    goProduct() {
      ...
      this.$router.push({name:"air_productnps_keyshow"});
    },
    goSell(){
      this.$router.push({name:"air_sellnps"})
    },
    goService(){
      this.$router.push({name:"air_service"})
    },
    // 柱状图
    initChartBar() {
      var arr_2015 = ["5.4 ↑", "4.1↑",  "-0.8↑"];
      var option = {
        tooltip: {
          trigger: "axis",
          axisPointer: {
