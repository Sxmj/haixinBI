    ...
    <el-row :gutter="20">
        ...
        <el-card class="hand">
          <div @click="goProduct">
            <el-row type="flex" justify="space-between" align="middle" style="padding:0 0 20px">
              <span class="span_h5 color_17b3a3">海信冰箱产品</span>
      ...
      <el-col :span="8">
        <el-card class="hand">
          <div @click="goSell">
            <el-row type="flex" justify="space-between" align="middle" style="padding:0 0 20px">
              <span class="span_h5 color_17b3a3">海信冰箱销售</span>
              <span class="span_box">2019年</span>
            </el-row>
      ...
      <el-col :span="8">
        <el-card class="hand">
          <div @click="goService">
            <el-row type="flex" justify="space-between" align="middle" style="padding:0 0 20px">
              <span class="span_h5 color_17b3a3">海信冰箱服务</span>
              <span class="span_box">2019年</span>
            </el-row>
