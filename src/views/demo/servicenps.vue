      ...
      <el-card>
        ...
        <div style="padding-left:125px;margin-top:30px">
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="sony" label="索尼" width="90" align="center"></el-table-column>
            ...
            <el-table-column prop="xiapu" label="夏普" width="90" align="center"></el-table-column>
            <el-table-column prop="xiaomi" label="小米" width="90" align="center"></el-table-column>
            <el-table-column prop="chuangwei" label="创维" width="90" align="center"></el-table-column>
            <el-table-column prop="tcl" label="TCL" width="90" align="center"></el-table-column>
            <el-table-column prop="haier" label="海尔" width="90" align="center"></el-table-column>
          </el-table>
        </div>
 <p style="margin-left:100px;color:#FFD700">* 政策达成度、热线服务指标base小于30，未出示。</p>
        <!-- 列表数据 -->
...
import {
  service_installrepresentat,
  service_installattention,
  service_installnpsData,
  service_fixnpsData,
  service_fixattention,
  service_fixrepresentat
} from "../../utils/data";
...
export default {
  ...
  data() {
    return {
      ...
      //服务NPS安装环节
      service_installrepresentat: service_installrepresentat,
      haixinData_x: [],
      service_installattention: service_installattention, //指标关注度
      data_lists: service_installnpsData,
      percentArray: [3.0, 2.8, 2.2, 2.6],

      //服务NPS维修环节
      service_fixrepresentat: service_fixrepresentat,
      haixinfixData_x: [],
      service_fixattention: service_fixattention, //指标关注度
      fixdata_lists: service_fixnpsData,
      fixpercentArray: [2.6, 2.8, 3.5, 2.0],
  ...
  created() {
    ...
    this.service_installattention = ranking(that.service_installattention);
    this.service_installrepresentat = getData2(
      service_installattention,
      that.service_installrepresentat
    );
    this.haixinData_x = getData_x(that.service_installrepresentat, [
      "\n" +
    ...
    this.service_fixattention = ranking(that.service_fixattention);
    this.service_fixrepresentat = getData2(
      service_fixattention,
      that.service_fixrepresentat
    );
    this.haixinfixData_x = getData_x(that.service_fixrepresentat, [
      "\n" +
        ...
        series: [
          {
            ...
            type: "bar",
            barWidth: "40%",
            data: that.service_installrepresentat,
            label: {
              normal: {
                show: true,
                position: "top",
          ...
          },
          {
            ...
            smooth: true,
            yAxisIndex: 1,
            data: that.service_installattention //[25, 14, 10, 10, 3, 10, 7]
          }
        ]
      };
        ...
        series: [
          {
            ...
            type: "bar",
            barWidth: "40%",
            data: that.service_fixrepresentat,
            label: {
              normal: {
                show: true,
                position: "top",
          ...
          },
          {
            ...
            smooth: true,
            yAxisIndex: 1,
            data: that.service_fixattention //[25, 14, 10, 10, 3, 10, 7]
          }
        ]
      };
      this.chartBar = echarts.init(
