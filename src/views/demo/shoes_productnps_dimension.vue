  ...
  methods: {
    handleClick(tab, event) {
      if (tab.$options.propsData.name == "price") {
        this.title = "洗衣机各价位产品NPS";
        this.titlep1 = "高档";
        this.titlep2 = "中档";
        this.titlep3 = "低档";
        this.titletop = 73.2;
        this.titlemiddle = 60.9;
        this.titlebottom = 53.4;
        this.showChart = true;
        this.xAxis = [
          {
            type: "category",
        ...
        this.title = "洗衣机各销售渠道产品NPS";
        this.titlep1 = "线上";
        this.titlep2 = "线下";
        this.titlep3 = "";
        this.titletop = 56.5;
        this.titlemiddle = 65.0;
        this.titlebottom = "";
        ...
        this.title = "洗衣机各类型产品NPS";
        this.titlep1 = "波轮";
        this.titlep2 = "滚筒";
        this.titlep3 = "";
        this.titletop = 54.7;
        this.titlemiddle = 64.7;
        this.titlebottom = "";
        this.showChart = false;
        this.xAxis = [
          {
