<template>
  <div class="tv_product">
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card>
          <h3 class="chart_title">海信电视销售</h3>
      ...
      <el-card>
        ...
        <div style="padding-left:125px;margin-top:30px">
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="tiane" label="小天鹅" width="90" align="center"></el-table-column>
            <el-table-column prop="lg" label="LG" width="90" align="center"></el-table-column>
            <el-table-column prop="songxia" label="松下" width="90" align="center"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      shoes_sellrepresentat: shoes_sellrepresentat,
      haixinData_x: [],
      shoes_sellattention: shoes_sellattention, //指标关注度
      data_lists: shoes_selldata,
      percentArray: [15.6, 3.6, 7.3, 7.0, 0.7],
  ...
  created() {
    ...
    this.shoes_sellattention = ranking(that.shoes_sellattention);
    this.shoes_sellrepresentat = getData2(
      shoes_sellattention,
      that.shoes_sellrepresentat
    );
    this.haixinData_x = getData_x(that.shoes_sellrepresentat, [
      "\n" +
        ...
        series: [
          {
            ...
            type: "bar",
            barWidth: "40%",
            data: that.shoes_sellrepresentat,
            label: {
              normal: {
                show: true,
                position: "top",
          ...
          },
          {
            ...
            smooth: true,
            yAxisIndex: 1,
            data: that.shoes_sellattention //[25, 14, 10, 10, 3, 10, 7]
          }
        ]
      };
