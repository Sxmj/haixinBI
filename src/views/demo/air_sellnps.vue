<template>
  <div class="tv_product">
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card>
          <h3 class="chart_title">海信空调销售</h3>
...
export default {
  ...
  data() {
    return {
      ...
      air_sellrepresentat: air_sellrepresentat,
      haixinData_x: [],
      air_sellattention: air_sellattention, //指标关注度
      data_lists: air_sellData,
      percentArray: [2.7, 1.7, 2.0, 1.2, 0.3],
  ...
  created() {
    ...
    this.air_sellattention = ranking(that.air_sellattention);
    this.air_sellrepresentat = getData2(
      air_sellattention,
      that.air_sellrepresentat
    );
    this.haixinData_x = getData_x(that.air_sellrepresentat, [
      "\n" +
      ...
      var option = {
        ...
        series: [
          ...
          },
          {
            ...
            smooth: true,
            yAxisIndex: 1,
            data: that.air_sellattention //[25, 14, 10, 10, 3, 10, 7]
          }
        ]
      };
