<template>
  <div class="tv_product">
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card>
          <h3 class="chart_title">海信冰箱销售</h3>
          <div id="TVproduct_chartBarBox" class="chart-box"></div>
          <p style="margin-left:100px;color:#FFD700">* 销售其他base＜30，结果未出示。</p>
        </el-card>
      </el-col>
    </el-row>
...
import {
  ice_sellkeyshowrepresentat,
  ice_sellkeyshowattention,
  icekeyshowsell_tableData
} from "../../utils/data";
...
export default {
  ...
  data() {
    return {
      ...
      ice_sellkeyshowrepresentat: ice_sellkeyshowrepresentat,
      haixinData_x: [],
      ice_sellkeyshowattention: ice_sellkeyshowattention, //指标关注度
      data_lists: icekeyshowsell_tableData,
      percentArray: [7.3, 3.9, 2.7, 2.1, "-"],
  ...
  created() {
    ...
    this.ice_sellkeyshowattention = ranking(that.ice_sellkeyshowattention);
    this.ice_sellkeyshowrepresentat = getData2(
      ice_sellkeyshowattention,
      that.ice_sellkeyshowrepresentat
    );
    this.haixinData_x = getData_x(that.ice_sellkeyshowrepresentat, [
      "\n" +
        ...
        series: [
          {
            ...
            type: "bar",
            barWidth: "40%",
            data: that.ice_sellkeyshowrepresentat,
            label: {
              normal: {
                show: true,
                position: "top",
          ...
          },
          {
            ...
            smooth: true,
            yAxisIndex: 1,
            data: that.ice_sellkeyshowattention //[25, 14, 10, 10, 3, 10, 7]
          }
        ]
      };
