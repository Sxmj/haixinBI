    ...
    <el-row :gutter="20">
        ...
        <el-card class="nps_card">
          ...
          <div class="nps_box">
            ...
            <div class="data_table">
              ...
              <p>2、左上方为洗衣机品类2019年的NPS权重计算公式</p>
              <p>【下图数据】</p>
              <p>展现洗衣机品类下的产品模块、销售模块、服务模块与竞品的对比情况</p>
        ...
        <el-card class="hand">
          <div @click="goProduct">
            <el-row type="flex" justify="space-between" align="middle" style="padding:0 0 20px">
              <span class="span_h5 color_17b3a3">海信洗衣机产品</span>
      ...
      <el-col :span="8">
        <el-card class="hand">
          <div @click="goSell">
            <el-row type="flex" justify="space-between" align="middle" style="padding:0 0 20px">
              <span class="span_h5 color_17b3a3">海信洗衣机销售</span>
              <span class="span_box">2019年</span>
            </el-row>
      ...
      <el-col :span="8">
        <el-card class="hand">
          <div @click="goService">
            <el-row type="flex" justify="space-between" align="middle" style="padding:0 0 20px">
              <span class="span_h5 color_17b3a3">海信洗衣机服务</span>
              <span class="span_box">2019年</span>
            </el-row>
...
export default {
  ...
  methods: {
    goProduct() {
      ...
      this.$router.push({name:"shoes_productnps_keyshow"});
    },
    goSell(){
      this.$router.push({name:"shoes_sellnps"})
    },
    goService(){
      this.$router.push({name:"shoes_service"})
    },
    // 柱状图
    initChartBar() {
      var arr_2015 = ["3.3↑", "3.3↑",  "1.8↑"];
      var option = {
        tooltip: {
          trigger: "axis",
          axisPointer: {
