<template>
  <div class="tv_product">
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card>
          <h3 class="chart_title">海信洗衣机服务NPS安装环节</h3>
    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card>
          <h3 class="chart_title">海信洗衣机服务NPS维修环节</h3>
          <div id="TVproductfix_chartBarBox" class="chart-box"></div>
          <p style="margin-left:100px;color:#FFD700">* 服务周期、政策达成度base＜30，结果未出示。</p>
        </el-card>
      </el-col>
    </el-row>
    <el-row :gutter="20" class="ranking">
...
import {
  shoes_installrepresentat,
  shoes_installattention,
  shoes_installdata,
  shoes_fixdata,
  shoes_fixattention,
  shoes_fixrepresentat
} from "../../utils/data";
...
export default {
  ...
  data() {
    return {
      ...
      //服务NPS安装环节
      shoes_installrepresentat: shoes_installrepresentat,
      haixinData_x: [],
      shoes_installattention: shoes_installattention, //指标关注度
      data_lists: shoes_installdata,
      percentArray: [5.2, 6.4, 1.5, 1.5, 0.2],

      //服务NPS维修环节
      shoes_fixrepresentat: shoes_fixrepresentat,
      haixinfixData_x: [],
      shoes_fixattention: shoes_fixattention, //指标关注度
      fixdata_lists: shoes_fixdata,
      fixpercentArray: [6.2, 4.7, 3.5, 4.2, 0.7],
  ...
  created() {
    ...
    this.shoes_installattention = ranking(that.shoes_installattention);
    this.shoes_installrepresentat = getData2(
      shoes_installattention,
      that.shoes_installrepresentat
    );
    this.haixinData_x = getData_x(that.shoes_installrepresentat, [
      "\n" +
    ...
    this.shoes_fixattention = ranking(that.shoes_fixattention);
    this.shoes_fixrepresentat = getData2(
      shoes_fixattention,
      that.shoes_fixrepresentat
    );
    this.haixinfixData_x = getData_x(that.shoes_fixrepresentat, [
      "\n" +
        ...
        this.xAxis1 = [
          {
            type: "category",
            // data: ['海信','三星','索尼','夏普','小米','TCL','海尔','创维'],
            data: getRanking(ranking_pr(this.fixhotline)).arr_name,
            axisPointer: {
              type: "shadow"
            },
            name: "品牌NPS排位",
        ...
        this.series1 = [
          {
            ...
            type: "bar",
            // data:[ 58.8, 65.6, 66.6, 53.7, "","51.0",55.0,"51.0"],
            data: getRanking(ranking_pr(this.fixhotline)).arr_2017,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  ...
                  // var colorList = ['#a3e1d4','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  //  return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.fixhotline)).arr_2017[
                    params.dataIndex
                  ].color;
                }
              }
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 58.3, 60.6, 67.2, 52.5, "",50.3,48.4,49.3],
            data: getRanking(ranking_pr(this.fixhotline)).arr_2018,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  // var colorList = ['#6dbccf','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9','#A9A9A9'];
                  // return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.fixhotline)).arr_2018[
                    params.dataIndex
                  ].color;
                }
              }
          ...
          },
          {
            ...
            type: "bar",
            // data:[ 62.4, 63.7, 66.0, 58.1, 56.5,55.9,54.1,56.3],
            data: getRanking(ranking_pr(this.fixhotline)).arr_2019,
            label: labelOption,
            itemStyle: {
              normal: {
                color: params => {
                  // var colorList = ['#17b3a3','#808080','#808080','#808080','#808080','#808080','#808080','#808080','#808080','#808080'];
                  // return colorList[params.dataIndex]
                  return getRanking(ranking_pr(this.fixhotline)).arr_2019[
                    params.dataIndex
                  ].color;
                }
              }
        ...
        series: [
          {
            ...
            type: "bar",
            barWidth: "40%",
            data: that.shoes_installrepresentat,
            label: {
              normal: {
                show: true,
                position: "top",
          ...
          },
          {
            ...
            smooth: true,
            yAxisIndex: 1,
            data: that.shoes_installattention //[25, 14, 10, 10, 3, 10, 7]
          }
        ]
      };
        ...
        series: [
          {
            ...
            type: "bar",
            barWidth: "40%",
            data: that.shoes_fixrepresentat,
            label: {
              normal: {
                show: true,
                position: "top",
          ...
          },
          {
            ...
            smooth: true,
            yAxisIndex: 1,
            data: that.shoes_fixattention //[25, 14, 10, 10, 3, 10, 7]
          }
        ]
      };
      this.chartBar = echarts.init(
